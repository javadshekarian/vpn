package com.nullstorm.vpn.parser.handler
...
import com.nullstorm.vpn.parser.AppConfig.DEFAULT_SUBSCRIPTION_ID
import com.nullstorm.vpn.parser.AppConfig.GEOIP_PRIVATE
import com.nullstorm.vpn.parser.AppConfig.GEOSITE_PRIVATE
import com.nullstorm.vpn.parser.AppConfig.TAG_DIRECT
import com.nullstorm.vpn.parser.AppConfig.VPN
import com.nullstorm.vpn.parser.dto.V2rayConfig
import com.nullstorm.vpn.parser.dto.entities.ProfileItem
import com.nullstorm.vpn.parser.dto.entities.RulesetItem
import com.nullstorm.vpn.parser.dto.entities.SubscriptionItem
import com.nullstorm.vpn.parser.enums.EConfigType
import com.nullstorm.vpn.parser.enums.Language
import com.nullstorm.vpn.parser.enums.RoutingType
import com.nullstorm.vpn.parser.enums.VpnInterfaceAddressConfig
import com.nullstorm.vpn.parser.handler.MmkvManager.decodeAllServerList
import com.nullstorm.vpn.parser.handler.MmkvManager.decodeServerConfig
import com.nullstorm.vpn.parser.handler.MmkvManager.decodeSubsList
import com.nullstorm.vpn.parser.handler.MmkvManager.decodeSubscription
import com.nullstorm.vpn.parser.handler.MmkvManager.encodeSubscription
import com.nullstorm.vpn.parser.handler.MmkvManager.removeSubscription
import com.nullstorm.vpn.parser.util.JsonUtil
